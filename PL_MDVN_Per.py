...
# RUN: python /Users/MariaGabriela/cellmodeller/Scripts/5_jun/PL_MDVN_Per.py /Users/MariaGabriela/cellmodeller/data/ex1_simpleGrowth-17-05-30-20-45/
...
def PL_mdvn(file, Ra, time, path, Per):
    ...
    Ra2 = Ra2[0]+Ra2[2]
    t = time[:3].replace(' ', '')
    plt.savefig('%sPL_MDVN/PLN_R_%s_t_%s_per_T.png' %(path,Ra2,t))
    plt.close()
...
with open(outfile, 'w') as out_file:
    ...
    for i in range (0,20):
            ...
            while c <= 6 :
                ...
                m, m1, m2, b, b1, b2= PL_mdvn(file_velocity,Ra, time, path, 0.81)
